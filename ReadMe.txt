...
- home에서 post 클릭했을 때 발행날짜, 작성자ID 및 레이아웃 수정했습니다.
- home에서 좋아요, 스크랩 버튼과 숫자 뜨도록 수정했습니다. 좋아요는 작동하는데 스크랩버튼 누르면 에러납니다. html에 잘못 옮긴건지 머가 문제인건지 모르겠습니다,, 백분들 도와주세요!!
- home 전체적인 정렬 레이아웃 수정했습니다. 가끔 왼쪽 정렬이 되는 경우가 있는데 추후 수정예정입니다.

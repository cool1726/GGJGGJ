...
- 오른쪽의 글 컨테이너에서 '어떤 책인지 확인하기' 버튼을 누르면 이어서 아래에 어떤 책인지 책 정보를 보여주게 됩니다. (아직 미완, book model에서 어떻게 받아오는지 알아보는 중)
- 평소에는 반응형으로 작동하지만 오른쪽의 글 컨테이너가 펼쳐진 상태에서의 반응형은 잘 먹히지 않을 수 있습니다. 이건 계속 수정중입니다~!